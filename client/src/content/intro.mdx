...
Esta API proporciona información sobre las siete criaturas mitológicas de la cultura [guaraní], incluyendo la historia resumida de cada una e imágenes relacionadas. Todas las referencias utilizadas para generar los contenidos están disponibles en [{origin}/api/myths/meta].
